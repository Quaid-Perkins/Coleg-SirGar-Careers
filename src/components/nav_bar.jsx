...
const opportunities = [
	...
	{
		link: "/career_compass/sports",
		name: "Sports",
	},
	{
		link: "/career_compass/travel",
		name: "Travel",
	},
];
...
const NavBar = () => {
	return (
		<div className="flex w-full items-center justify-between p-5 bg-primary text-base-200">
			<A
				href="/career_compass/"
				className="flex items-center justify-center gap-1.5 font-bold text-lg"
			>
				<img
			...
			<div className="inline-flex items-center gap-8 *:not-last:hover:underline">
				...
				<A href="/career_compass/new-skills">New Skills</A>
				<A href="/career_compass/resources">Resources</A>
				<ThemeToggleButton />
